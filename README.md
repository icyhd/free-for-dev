...
以下是 README.md 文件中的“目录”部分的中文翻译：

# 目录

  * [主要云提供商的永久免费额度](#major-cloud-providers)
  ...
  * [CDN和防护](#cdn-and-protection)
  * [持续集成与持续部署（CI/CD）](#ci-and-cd)
  * [内容管理系统（CMS）](#cms)
  ...
  * [生成式AI](#generative-ai)
  * [基础设施即服务（IaaS）](#iaas)
  * [IDE与代码编辑](#ide-and-code-editing)
  * [国际手机号码验证API与SDK](#international-mobile-number-verification-api-and-sdk)
  * [问题跟踪与项目管理](#issue-tracking-and-project-management)
  * [日志管理](#log-management)
  * [移动应用分发与反馈](#mobile-app-distribution-and-feedback)
  * [管理系统](#management-system)
  * [消息与流服务](#messaging-and-streaming)
  * [杂项](#miscellaneous)
  * [监控](#monitoring)
  * [平台即服务（PaaS）](#paas)
  ...
  * [Flutter相关与无需Mac构建iOS应用](#flutter-related-and-building-ios-apps-without-mac)
  * [搜索](#search)
  ...
  * [隧道、WebRTC、WebSocket服务器及其他路由器](#tunneling-webrtc-web-socket-servers-and-other-routers)
  * [测试](#testing)
  * [团队与协作工具](#tools-for-teams-and-collaboration)
  * [翻译管理](#translation-management)
  * [与Vagrant相关](#vagrant-related)
  * [访客会话录制](#visitor-session-recording)
  * [网站托管](#web-hosting)
  * [评论平台](#commenting-platforms)
  * [基于浏览器的硬件仿真（Javascript编写）](#browser-based-hardware-emulation-written-in-javascript)
...
## 主要云提供商
  ...
  * [Google Cloud Platform](https://cloud.google.com)
    ...
    * Cloud Firestore - 1GB 存储空间，每天读取 50,000 次，写入 20,000 次，删除 20,000 次
    * Compute Engine - 1 个不可抢占的 e2-micro、30GB HDD、5GB 快照存储（仅限于某些区域）、每月从北美到所有区域目的地（中国和澳大利亚除外）的 1 GB 网络出站流量
